...
class JazzyHelper implements AbsListView.OnScrollListener {

    private static final int STANDARD = 0;
    private static final int GROW = 1;
    private static final int CARDS = 2;
    private static final int CURL = 3;
    private static final int WAVE = 4;
    private static final int FLIP = 5;
    private static final int FLY = 6;
    private static final int REVERSE_FLY = 7;
    private static final int HELIX = 8;
    private static final int FAN = 9;
    private static final int TILT = 10;
    private static final int ZIPPER = 11;
    private static final int FADE = 12;
    private static final int TWIRL = 13;
    private static final int SLIDE_IN = 14;
    ...
    private static final int MAX_VELOCITY_OFF = 0;
    ...
    private JazzyHelper(Context context, AttributeSet attrs) {
        mAlreadyAnimatedItems = new HashSet<>();
        int transitionEffect = HELIX;
        int maxVelocity = 0;

        if (context != null && attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, com.twotoasters.jazzylistview.R.styleable.JazzyListView);
            transitionEffect = a.getInteger(com.twotoasters.jazzylistview.R.styleable.JazzyListView_effect, STANDARD);
            maxVelocity = a.getInteger(com.twotoasters.jazzylistview.R.styleable.JazzyListView_max_velocity, MAX_VELOCITY_OFF);
            mOnlyAnimateNewItems = a.getBoolean(com.twotoasters.jazzylistview.R.styleable.JazzyListView_only_animate_new_items, false);
            mOnlyAnimateOnFling = a.getBoolean(com.twotoasters.jazzylistview.R.styleable.JazzyListView_max_velocity, false);
            mSimulateGridWithList = a.getBoolean(com.twotoasters.jazzylistview.R.styleable.JazzyListView_simulate_grid_with_list, false);
            a.recycle();
        }
    ...
    private void onScrolled(ViewGroup viewGroup, int firstVisibleItem, int visibleItemCount, int totalItemCount) {
    ...
    private void setTransitionEffect(int transitionEffect) {
    ...
    private void setTransitionEffect(JazzyEffect transitionEffect) {
    ...
    private void setMaxAnimationVelocity(int itemsPerSecond) {
