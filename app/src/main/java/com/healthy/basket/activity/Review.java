...
import com.healthy.basket.Adapter.reviewadapter;
import com.healthy.basket.Getset.reviewgetset;
...
public class Review extends AppCompatActivity {
        ...
        btn_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (usercomment.equals("")) {
                    edt_review.setError(getString(R.string.review));
                } else {
                    if (checkInternet(Review.this)) {
                        dialog.dismiss();
    ...
    private void showSnack() {
        Snackbar snackbar = Snackbar.make(findViewById(R.id.coordinator), R.string.need_login_for_review, Snackbar.LENGTH_LONG);
    ...
    private void openReviewDialog(ArrayList<reviewgetset> reviewlist, int position) {
        ...
        try {
            if (isValid(image)) {
                ...
                Picasso.with(Review.this).load(imagePath).into(img_user);
    ...
    class getRateDetail extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            if (revmsg.equals( "Success" )) {
                ...
                builder.setMessage(R.string.thanks_you)
                ...
                Toast.makeText(Review.this, R.string.allready_given, Toast.LENGTH_LONG).show();
            }
        }
