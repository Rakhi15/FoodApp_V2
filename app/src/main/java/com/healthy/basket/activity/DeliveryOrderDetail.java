...
import com.healthy.basket.Adapter.OrderDetailAdapter;
...
public class DeliveryOrderDetail extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        txt_orderAmount.setText(getString(R.string.order_amount) + " " + AppClass.preferences.getCurrency() + " " + orderAmount);
