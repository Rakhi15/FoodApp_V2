...
import com.healthy.basket.Adapter.CityListAdapter;
...
public class SettingPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        defaultRadius = Integer.parseInt(getString(R.string.radius));
        noRadius = Integer.parseInt(getString(R.string.radius));
    ...
    private void initView() {
        ...
        radius_seekBar.setMax(defaultRadius);
        if (radius == noRadius) {
