...
public class Register extends AppCompatActivity {
    ...
    private void submitForm() {
        ...
        if (!checkbox.isChecked()) {
            Toast.makeText(getApplicationContext(), R.string.select_terms, Toast.LENGTH_SHORT).show();
            return;
        }
    ...
    private void postdata() {
        ...
        if (picturepath.isEmpty()){
            HttpEntity entity = MultipartEntityBuilder.create().setMode(HttpMultipartMode.BROWSER_COMPATIBLE)
                    ...
                    .addTextBody("referral_code", "1234").build();
                    //.addBinaryBody("file", new File(picturepath), ContentType.create("application/octet-stream"), "filename").build();


            httpPost = new HttpPost(getString(R.string.link) + getString(R.string.servicepath) + "userregister.php");
            ...
            if (strSuccess.equals("Success")) {
                ...
                switch (key) {
                    case "": {
                        ...
                        startActivity(iv);
                        Toast.makeText(Register.this, R.string.reg, Toast.LENGTH_LONG).show();
                        finish();
