...
public class LoginAsDelivery extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MainActivity.changeStatsBarColor(LoginAsDelivery.this);
    ...
    private void setFont() {
        ...
        edit_email.setTypeface(MainActivity.tf_opensense_regular);
        edit_pwd.setTypeface(MainActivity.tf_opensense_regular);
    ...
    private void submitform() {
        ...
        if (MainActivity.checkInternet(LoginAsDelivery.this))
            submitdata(userEmail, password);

        else {
            MainActivity.showErrorDialog(LoginAsDelivery.this);
        }
