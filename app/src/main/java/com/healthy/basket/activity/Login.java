...
import com.healthy.basket.Getset.registergetset;
...
public class Login extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MainActivity.changeStatsBarColor(Login.this);
    ...
    private void initializations() {
        ...
        btn_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                iv.putExtra("key", "" + key);
                iv.putExtra("delivery_charge", "" + getIntent().getStringExtra("delivery_charge"));
                startActivity(iv);
            }
        });
        btn_forget_pass.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                editor.putString("delete", "" + prodel);
                editor.apply();
                Intent iv = new Intent(Login.this, ForgetPasswordActivity.class);
                iv.putExtra("key", "" + key);
                iv.putExtra("delivery_charge", "" + getIntent().getStringExtra("delivery_charge"));
                startActivity(iv);
            }
    ...
    private void setfont() {
        edit_phone = findViewById(R.id.edit_phone);
        edit_phone.setTypeface(MainActivity.tf_opensense_regular);
        edt_pwd = findViewById(R.id.edit_pwd);
        edt_pwd.setTypeface(MainActivity.tf_opensense_regular);
        btn_register = findViewById(R.id.btn_register);
        btn_register.setTypeface(MainActivity.tf_opensense_regular);
        btn_forget_pass = findViewById(R.id.btn_forget_pass);
        btn_forget_pass.setTypeface(MainActivity.tf_opensense_regular);
        edit_phone.addTextChangedListener(new MyTextWatcher(edit_phone));
        edt_pwd.addTextChangedListener(new MyTextWatcher(edt_pwd));
        btn_login = findViewById(R.id.btn_login);
        btn_login.setTypeface(MainActivity.tf_opensense_regular);
        btn_login_delivery.setTypeface(MainActivity.tf_opensense_regular);
        btn_fb = findViewById(R.id.btn_fb);
        btn_fb.setTypeface(MainActivity.tf_opensense_regular);
        btn_google = findViewById(R.id.btn_google);
        btn_google.setTypeface(MainActivity.tf_opensense_regular);
    ...
    private void getUserDetail(LoginResult loginResult) {
        ProgressDialog d = new ProgressDialog( Login.this );
        ...
        GraphRequest data_request = GraphRequest.newMeRequest( loginResult.getAccessToken(), new GraphRequest.GraphJSONObjectCallback() {
            ...
            public void onCompleted(JSONObject json_object, GraphResponse response) {
                ...
                try {
                    ...
                    Toast.makeText( Login.this,getString( R.string.facebook_validation ),Toast.LENGTH_SHORT ).show();
                }
            }
        } );
    ...
    private void submitform() {
        ...
        if (MainActivity.checkInternet(Login.this))
            new getlogin().execute();
        else {
            MainActivity.showErrorDialog(Login.this);
        }
...
//    }
    ...
    private boolean validatephone() {
        if (edit_phone.getText().toString().trim().isEmpty()){
            ...
            requestFocus(edit_phone);
            return false;
        }
        else inputLayoutEmail.setErrorEnabled(false);
        return true;
//        String regex = "(0/91)?[6-9][0-9]{9}";
//        if (!edit_phone.getText().toString().trim().matches(regex)) {
//            inputLayoutEmail.setError(getString(R.string.err_msg_phone));
//            requestFocus(edit_phone);
//            return false;
//        } else {
...
//        return true;
    ...
    public void onConnected(Bundle bundle) {
        ...
        Toast.makeText(this, R.string.user_connect, Toast.LENGTH_LONG).show();
    ...
    class ViewDialog {
        void showDialog(Activity activity) {
            ...
            txt_description.setTypeface(MainActivity.tf_opensense_regular);
            ...
            btnValidate.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (countryCode.length() > 0 && phoneNumber.length() == 10) {
                        ...
                        Toast.makeText(getApplicationContext(), R.string.txt_invalid_phonenumber, Toast.LENGTH_SHORT).show();
                    }
                }
            });
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            if (isSuccess) {
                ...
                switch (key) {
                    ...
                    case "UploadMedicalOrder" : {
                        finish();
                        break;
                    }

                }
                Toast.makeText(Login.this, R.string.login, Toast.LENGTH_LONG).show();
            }
        }
