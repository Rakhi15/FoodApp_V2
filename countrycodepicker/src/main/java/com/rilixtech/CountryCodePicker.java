...
public class CountryCodePicker extends RelativeLayout {
   ...
   * if you want to set JM +876(India) as default country, mDefaultCountryCode =  876
  ...
  public void setDefaultCountryUsingNameCode(String countryIso) {
    // Comment BY Deepak on 30 April
    //Country defaultCountry = CountryUtils.getByNameCodeFromAllCountries(getContext(), countryIso);
    Country defaultCountry = CountryUtils.getByNameCodeFromAllCountries(getContext(), "IN");
